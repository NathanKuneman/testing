...
for folder in subfolders:
    ...
    for file in event_files:
        team = file
        process = subprocess.Popen([f'wine {folder}/BEVENT.EXE -y {year} -f 0,10,11,14,15,26,27,28,34,43,59,60,61,66,67,68 {folder}/{file} > ../data/processed_events/{file[:-4]}.txt'], shell=True)
        #process.terminate()
